...
const defaultMessages: Array<MessageModel> = [
  {
    user: 4,
    type: 'in',
    text: '저는 회사 1층에서 빙빙 돌며 3천보 채우고 왔더니 약간 마음이 놓이네요.',
    time: '2 mins',
  },
  {
    user: 2,
  ...
  },
  {
    user: 2,
    type: 'out',
    text: '아직 5천이 안돼요!아, 어떻게 또 걸음을 채우죠?',
    time: '1 Hour',
  },
  {
    user: 4,
  ...
  },
  {
    user: 4,
    type: 'in',
    text: '그래도 휴일에 일부러 움직이게 해주니까 그것만으로도 만족해요. by clicking here: <a href="https://keenthemes.com">Keenthemes.com</a>',
    time: '3 Hours',
  },
  {
    user: 2,
